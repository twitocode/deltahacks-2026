      ...
      <div className="relative w-full h-screen overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col h-full px-8 md:px-16 container mx-auto">
          ...
          <main className="flex-1 flex flex-col items-center justify-center text-center mt-[-80px]">
            ...
            <button
              className="mt-16 bg-white text-gray-900 px-8 py-3 rounded-full font-medium text-sm hover:bg-gray-300 hover:scale-110 transition-all duration-300 ease-in-out shadow-lg cursor-pointer"
