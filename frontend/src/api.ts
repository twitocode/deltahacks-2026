import { generateFakeServerResponse, type ServerGridResponse } from "./utils/heatmapGenerator";
...
export async function fetchPrediction(payload: { latitude: number; longitude: number; [key: string]: any }): Promise<ServerGridResponse> {
  try {
